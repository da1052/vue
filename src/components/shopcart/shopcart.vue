    ...
    <div class="shopcart">
      ...
      <div class="content" @click="toggleList">
        ...
        <div class="content-left">
          ...
          <div class="price" :class="{'highlight':totalPrice>0}">￥{{totalPrice}}</div>   <!-- 价格-->
          <div class="desc">另需配送费￥{{deliveryPrice}}元</div>     <!-- 配送价-->
        </div>
        <!--右边-->
      ...
      <div class="ball-container">
        <div v-for="ball in balls" :key="ball.id" class="balls">
