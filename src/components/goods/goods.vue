  ...
  <div>
    <div class="goods">
            ...
            <ul>
              <li v-for="food in item.foods" :key="food.id" class="food-item border-1px"
                ...
                <div class="content">
                  ...
                  <div class="cartcontrol-wrapper border-none" >
      ...
      <shopcart :selectFoods="selectFoods" :deliveryPrice="seller.deliveryPrice" :minPrice="seller.minPrice"
                ref="shopcart" @add3="_drop"></shopcart>
    </div>
    <food :food="selectedFood" ref="food" @add="_drop" @add2="_drop"></food>
  </div>
</template>
    ...
    export default {
      ...
      methods: {
        ...
        selectMenu (index, event) {
          ...
          // console.log('index' + index + 'curr' + this.currentIndex);
